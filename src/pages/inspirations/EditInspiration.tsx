...
const EditInspiration = () => {
    ...
    const [defaultTN, setDefaultTN] = useState<any>();
            ...
            children: <div className="form-container">
                ...
                <div className="form-wrap">
                    ...
                    >
                        ...
                        {getLimitUploadFormItem('thumbnail', 'Thumbnail', normFile, handlePreview, checkFileType, defaultTN)}
                    </Form>
                </div>
