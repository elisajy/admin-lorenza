...
const Partners = () => {
    ...
    const fetchPartners = () => {
        setPartners([]);
        try {
            fetch(`${import.meta.env.VITE_API_KEY}/all-home-partners`, {
                method: 'GET',
                headers: {
    ...
    const deletion = (record: any) => {
        ...
        setConfirmation({
            ...
            action: async () => {
                ...
                fetch(`${import.meta.env.VITE_API_KEY}/delete-home-partner`, {
                    method: 'POST',
                    headers: {
    ...
    return (
        <>
            ...
            <div>
                <Table dataSource={partners} pagination={pagination}
